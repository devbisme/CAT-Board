...
always @(sdramCntl_inst_sAddr_r, sdramCntl_inst_bank_s, sdramCntl_inst_sDataDir_r, sdramCntl_inst_sData_r, sdramCntl_inst_cmd_r) begin: SDRAM_TEST_SDRAMCNTL_INST_SDRAM_PIN_MAP
    sd_intf_cke = 1;
    sd_intf_cs = 0;
